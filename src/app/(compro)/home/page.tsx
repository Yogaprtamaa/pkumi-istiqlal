...
// --- DATA AKADEMIK ---
const akademikItems = [
  { title: "Agenda", icon: Calendar, link: "/akademik/agenda", desc: "Jadwal Kuliah & Seminar" },
  { title: "Penelitian", icon: Scroll, link: "/akademik/penelitian", desc: "Judul Disertasi & Tesis" },
  { title: "Mata Kuliah", icon: Book, link: "/akademik/matkul", desc: "Silabus Pembelajaran" },
  { title: "Kalender", icon: Clock, link: "/akademik/kalender", desc: "Kalender Akademik" },
  { title: "Jurnal", icon: FileText, link: "/akademik/jurnal", desc: "Publikasi Ilmiah PKUMI" },
  { title: "Khazanah", icon: Library, link: "/akademik/khazanah", desc: "Khazanah PKUMI" },
  { title: "Kurikulum", icon: GraduationCap, link: "/akademik/kurikulum", desc: "Struktur Program Studi" },
  { title: "Pendaftaran", icon: PenTool, link: "/pendaftaran", desc: "Penerimaan Kader Baru" },
];
...
export default function Home() {
  ...
  // ✅ PERBAIKAN: Definisi highlightQuestions ditambahkan di sini
  ...
  return (
    <main className="relative font-sans text-slate-800 bg-slate-50 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-5 space-y-6 top-32 sticky">
              ...
              <h2 className="text-3xl font-bold text-slate-900 leading-tight">Mewujudkan Ulama Wasathiyah yang Responsif Zaman</h2>
      ...
      <section className="py-24 bg-slate-50 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-2xl font-bold text-slate-900 mb-4">Layanan Akademik Mahasantri</h2>
            <p className="text-slate-500 text-sm">Akses informasi perkuliahan, penelitian, dan publikasi ilmiah.</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex justify-between items-end mb-12">
            <div>
              ...
              <h2 className="text-2xl font-bold text-slate-900">Berita & Rubrik Opini</h2>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center mb-10 gap-6">
            <div>
              ...
              <h2 className="text-2xl font-bold">Galeri Kegiatan PKUMI</h2>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="relative h-64 md:h-48 flex items-center justify-center">
            <AnimatePresence mode="wait">
              ...
              >
                <p className="text-lg md:text-xl font-medium text-slate-800 leading-relaxed mb-6">
                  "{testimonials[currentTesti].text}"
                </p>
                <div>
                  <h5 className="font-bold text-slate-900 text-base">{testimonials[currentTesti].name}</h5>
      ...
      {/* =========================================
          8. FAQ (PERBAIKAN ERROR)
      ========================================= */}
      <section className="py-20 bg-white border-t border-slate-100">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold text-slate-900 mb-2">Pertanyaan Umum (FAQ)</h2>
          <p className="text-slate-500 mb-10">
            Pertanyaan yang sering ditanyakan oleh calon mahasantri.
          </p>

          <div className="grid gap-4 text-left">
            {highlightQuestions.map((question, i) => (
              <Link
                key={i}
                // 🚀 LOGIC: Mengirim teks pertanyaan ke URL sebagai parameter 'q'
                href={`/faq?q=${encodeURIComponent(question)}`}
                className="group flex justify-between items-center p-5 rounded-2xl bg-slate-50 border border-slate-100 hover:border-emerald-200 hover:bg-emerald-50/50 transition-all cursor-pointer shadow-sm hover:shadow-md"
              >
                <span className="font-medium text-slate-700 group-hover:text-emerald-700 transition-colors">
                  {question}
                </span>
                <div className="bg-white p-2 rounded-full border border-slate-100 group-hover:border-emerald-200 transition-colors">
          ...
          <Link
            href="/faq"
            className="inline-flex items-center gap-2 mt-10 text-emerald-600 font-bold hover:text-emerald-700 hover:underline transition-colors"
          >
            <HelpCircle size={20} />
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-2xl font-bold mb-6">Sekretariat PKUMI</h2>
