        ...
        */}
        <header className="pt-8 pb-10 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto text-center sm:text-left">
          ...
          <div className="mb-6">
            <Link
              href="/artikel"
              className="inline-flex items-center text-sm font-medium text-gray-500 hover:text-islamGreen transition-colors"
            >
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between border-t border-b border-gray-100 py-6 gap-4">
            <div className="flex items-center gap-4">
              ...
              <div className="text-left">
                ...
                <div className="flex items-center gap-3 text-xs text-gray-500 mt-1">
                  ...
                  <span className="flex items-center gap-1 text-islamGreen font-medium">
                    <Clock className="h-3 w-3" /> {article.readTime} min baca
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                variant="ghost"
                size="icon"
                className="text-gray-400 hover:text-[#1877F2] hover:bg-blue-50"
              >
              ...
              <Button
                variant="ghost"
                size="icon"
                className="text-gray-400 hover:text-[#1DA1F2] hover:bg-sky-50"
              >
              ...
              <Button
                variant="ghost"
                size="icon"
                className="text-gray-400 hover:text-[#0A66C2] hover:bg-blue-50"
              >
              ...
              <Button
                variant="ghost"
                size="icon"
                className="text-gray-400 hover:text-islamGreen hover:bg-islamGreen/10"
              >
            ...
            <div className="lg:col-span-8">
              ...
              <div className="mt-12 pt-8 border-t border-gray-100">
                <div className="flex flex-wrap gap-2 mb-8">
                  {["Islam", "Kajian", article.rubrik.name, "Viral"].map(
                    (tag) => (
                      <Badge
                        key={tag}
                        variant="secondary"
                        className="px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-600 rounded-lg cursor-pointer transition-colors"
                      >
                        #{tag}
                      </Badge>
                    )
                ...
                <div className="bg-islamGreen/5 border border-islamGreen/10 rounded-2xl p-6 sm:p-8 text-center">
                  ...
                  <p className="text-gray-600 mb-6 text-sm">
                    Bantu sebarkan kebaikan dengan membagikan artikel ini kepada
                    kerabat Anda.
                  </p>
              ...
              <div className="sticky top-24 space-y-8">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500 mt-1 leading-relaxed">
                        Kontributor aktif di Nur Berita. Spesialis kajian fiqih
                        dan muamalah kontemporer.
                      </p>
                      <Button
                        variant="link"
                        className="p-0 h-auto text-islamGreen mt-2 text-sm font-bold"
                      >
                        Lihat Profil &rarr;
                      </Button>
                    </div>
                ...
                <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100">
                    ...
                    {sidebarRelated.map((item, idx) => (
                      ...
                      >
                        ...
                        <span className="text-xs text-gray-400">
                          {formatViews(item.views)} pembaca
                        </span>
                      </Link>
                    ))}
                  </div>
                  <Link href={`/rubrik/${article.rubrik.slug}`}>
                    <Button
                      variant="outline"
                      className="w-full mt-6 bg-white border-gray-200 text-gray-600 hover:text-islamGreen"
                    >
                      Lihat Semua
                    </Button>
                  </Link>
