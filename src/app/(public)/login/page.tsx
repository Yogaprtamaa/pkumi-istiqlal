/**
 * Login Page
 * Halaman login dengan desain modern dan user-friendly
          ...
          <div className="bg-linear-to-br from-islamGreen to-islamGreen-dark px-8 py-10 text-center text-white relative overflow-hidden">
            ...
            <div className="absolute inset-0 opacity-10">
              <svg className="w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
                <pattern id="login-pattern" patternUnits="userSpaceOnUse" width="10" height="10">
          ...
          <div className="p-8">
            ...
            <div className="mb-6 rounded-2xl bg-blue-50 p-5 text-sm text-blue-800 border border-blue-100">
              ...
              <p className="mt-2 text-blue-600 leading-relaxed">
                Anda bisa membaca artikel tanpa login. Login hanya diperlukan untuk mengirim konten baru.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <Link href="#" className="text-islamGreen hover:text-islamGreen-dark font-medium">
                  Lupa password?
                </Link>
              </div>
            ...
            <p className="text-center text-gray-600">
              Belum punya akun?{' '}
              <Link href="/register" className="font-semibold text-islamGreen hover:text-islamGreen-dark transition-colors">
                Daftar sekarang
              </Link>
            </p>
          </div>
